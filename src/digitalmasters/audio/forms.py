...
class ItemSearch(forms.Form):
    '''Form for searching for :class:`~digitalmasters.audio.models.AudioObject`
    instances.'''
...
class SimpleNoteForm(XmlObjectForm):
    ...
    a MODS :class:`~digitalmasters.mods.Note`.  Displays text content input only,
...
class SimpleDateForm(XmlObjectForm):
    ...
    :class:`~digitalmasters.mods.Date`.  Currently only allows editing the date
...
class OriginInfoForm(XmlObjectForm):
    ...
    :class:`~digitalmasters.mods.OriginInfo`.  Currently only consists
...
class ModsEditForm(XmlObjectForm):
    ...
    :class:`~digitalmasters.audio.models.AudioMods`.
    """
...
class SourceTechForm(XmlObjectForm):
    ...
    :class:`~digitalmasters.audio.models.SourceTech` metadata.
    """
...
class DigitalTechForm(XmlObjectForm):
    """Custom :class:`~eulcore.django.forms.XmlObjectForm` to edit
    :class:`~digitalmasters.audio.models.DigitalTech` metadata.
    """
...
class AudioObjectEditForm(forms.Form):
    ...
    :class:`~digitalmasters.audio.models.AudioObject`.

    Takes an :class:`~digitalmasters.audio.models.AudioObject`. This stands in contrast
    ...
    :class:`~digitalmasters.audio.models.AudioObject` by editing multiple XML
